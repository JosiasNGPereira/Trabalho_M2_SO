...
//COMO RODAR ESTA MERDA !
//---Compilar---
// g++ main.cpp -o memory_test -std=c++11
//---------
//rodar o arquivo compildo
//./memory_test 
//----------------
...
void FastMeasure()
{
    ...
    BusyWait(500);
    //Mudar os parametros aqui para ter resultados diferentes.
    //Analisar e explicar porque muda / Adicionar as informações no relatório.
...
{
    FastMeasure();
    //tempo para analisar as pages faults
    sleep(20);
    return 0;
}